    ...
    // ============================================
    {
      ...
      missions: [
        // Mission 1-2: 개념 소개 (interactive-lesson, 15분)
        {
          ...
          realWorldExample: '라면 끓이기 순서: 1) 냄비에 물 넣기 → 2) 불 켜기 → 3) 물 끓이기 → 4) 면과 스프 넣기 → 5) 완성',
          hints: [
            '요리 레시피를 생각해보세요',
        ...
        // Mission 3-5: 시각적 알고리즘 (drag-drop, visual-puzzle, 30분)
        {
          id: '1-1-3',
          title: '라면 끓이기 알고리즘',
          description: '맛있는 라면을 끓이는 순서를 올바르게 배열해요',
          type: 'drag-drop',
          difficulty: 'beginner',
          exp: 60,
          estimatedMinutes: 8,
          ...
          realWorldExample: '물이 끓기 전에 면을 넣으면 불어서 맛없어요. 순서가 중요하죠!',
          hints: [
            '요리를 시작하려면 먼저 냄비가 필요해요',
            '물이 끓어야 면을 넣을 수 있어요',
            '다 익으면 불을 끄고 그릇에 담아요'
          ],
          blocks: [
          ...
          commonMistakes: [
            '물 넣기 전에 불 켜기 - 빈 냄비를 가열하면 위험해요',
            '물이 안 끓었는데 면 넣기 - 면이 불어서 맛없어요',
            '불 안 끄고 그릇에 담기 - 안전 위험!'
          ],
                    challenges: [
                    {
        ...
        },
        {
          id: '1-1-4',
          title: '화분에 꽃 심기',
          description: '화분에 꽃을 심는 순서를 올바르게 정해요',
          type: 'drag-drop',
          difficulty: 'beginner',
          exp: 60,
          estimatedMinutes: 10,
          phase: 'modify',
          concept: '순차 실행',
          conceptExplanation: '화분 심기도 알고리즘이에요! 순서를 지켜야 꽃이 잘 자라요.',
          learningObjectives: [
            '물리적 의존성이 있는 순서를 이해한다',
            '논리적 순서를 판단할 수 있다'
          ],
          realWorldExample: '흙 없이 꽃을 심을 수 없고, 화분 없이 흙을 넣을 수 없어요!',
          hints: [
            '화분이 있어야 흙을 넣을 수 있어요',
            '흙이 있어야 꽃을 심을 수 있어요',
            '심은 후에 물을 줘야 뿌리가 활착해요'
          ],
          blocks: [
            '화분 준비하기',
            '화분 바닥에 자갈 깔기',
          ...
          hints: [
            ...
            '순서를 바꿨을 때 이상한지 확인해보세요'
                    ...
                    challenges: [
                    {
                              "id": "c1",
                              "title": "순서 바꾸기 실험",
                              "description": "아래 코드는 순서가 잘못되었어요. 올바른 순서로 다시 작성하세요. (힌트: 세수를 하려면 먼저 물을 틀어야 해요!)",
                              "difficulty": "easy",
                              "starterCode": "# 순서가 뒤죽박죽이에요! 올바른 순서로 고치세요\n\nprint(\"3. 세수한다\")\nprint(\"1. 세면대로 간다\")\nprint(\"4. 수건으로 닦는다\")\nprint(\"2. 물을 틴다\")\n",
                              "solution": "print(\"1. 세면대로 간다\")\nprint(\"2. 물을 틴다\")\nprint(\"3. 세수한다\")\nprint(\"4. 수건으로 닦는다\")",
                              "hints": [
                                        "먼저 세면대에 가야 물을 틀 수 있어요",
                                        "물이 있어야 세수할 수 있어요 - 이것이 '의존성'이에요",
                                        "1번부터 4번까지 순서대로 print()를 배치하세요"
                              ],
                              "estimatedMinutes": 3,
                              "feedback": {
                                        "perfect": "순서 의존성을 완벽히 이해했어요! 세수 전에 물이 필요하다는 관계를 잘 파악했어요.",
                                        "good": "좋아요! 순서를 잘 맞췄어요. 각 단계가 왜 그 순서인지도 생각해보세요.",
                                        "partial": "일부 순서가 아직 어색해요. 각 단계가 이전 단계에 의존하는지 확인하세요.",
                                        "wrong": "각 동작을 실제로 해본다고 상상하세요. 물 없이 세수할 수 있나요?"
                              }
                    },
                    {
                              "id": "c2",
                              "title": "의존성 찾기",
                              "description": "아래 활동들 중 순서를 바꿔도 되는 것과 바꾸면 안 되는 것을 구분하세요. 순서가 바뀌어도 괜찮은 것만 출력하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 순서를 바꿔도 괜찮은 것만 print()로 출력하세요\n# (바꾸면 안 되는 것은 주석 처리하세요)\n\nprint(\"양말 신기 -> 신발 신기\")      # 바꿔도 될까?\nprint(\"이 닦기 -> 세수하기\")          # 바꿔도 될까?\nprint(\"계란 깨기 -> 프라이팬에 굽기\")  # 바꿔도 될까?\nprint(\"수학 숙제 -> 국어 숙제\")        # 바꿔도 될까?\n",
                              "solution": "# print(\"양말 신기 -> 신발 신기\")      # X - 양말 먼저!\nprint(\"이 닦기 -> 세수하기\")          # O - 독립적\n# print(\"계란 깨기 -> 프라이팬에 굽기\")  # X - 깨야 구울 수 있음\nprint(\"수학 숙제 -> 국어 숙제\")        # O - 독립적",
                              "hints": [
                                        "A를 안 하면 B를 못 하는 관계인지 생각하세요",
                                        "양말 없이 신발을 신을 수는 있지만, 순서가 자연스러운지 생각하세요",
                                        "두 활동이 서로 영향을 주지 않으면 순서를 바꿔도 돼요"
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "의존성과 독립성의 차이를 정확히 구분했어요! 프로그래밍에서도 이 개념이 매우 중요해요.",
                                        "good": "대부분 잘 구분했어요! 의존성 판단 감각이 좋아요.",
                                        "partial": "의존성이란 'A 없이 B를 할 수 없는 관계'예요. 다시 생각해보세요.",
                                        "wrong": "각 쌍에서 첫 번째를 안 하면 두 번째를 할 수 있는지 확인하세요."
                              }
                    },
                    {
                              "id": "c3",
                              "title": "요리 순서 알고리즘",
                              "description": "계란프라이를 만드는 순서가 뒤섞여 있어요. 올바른 순서로 재배치하고, 각 단계에 의존하는 이유를 주석으로 적으세요.",
                              "difficulty": "medium",
                              "starterCode": "# 계란프라이 만들기 - 올바른 순서로 재배치하세요!\n# 각 단계 옆에 왜 그 순서인지 주석을 달아보세요\n\nprint(\"소금을 뿌린다\")\nprint(\"계란을 깬다\")\nprint(\"프라이팬에 기름을 두른다\")\nprint(\"불을 켠다\")\nprint(\"접시에 담는다\")\n",
                              "solution": "print(\"1. 불을 켠다\")          # 열이 있어야 요리 가능\nprint(\"2. 프라이팬에 기름을 두른다\")  # 달궈진 팬에 기름\nprint(\"3. 계란을 깬다\")        # 기름 위에 계란\nprint(\"4. 소금을 뿌린다\")      # 익는 동안 간하기\nprint(\"5. 접시에 담는다\")      # 다 익으면 담기",
                              "hints": [
                                        "요리를 시작하려면 먼저 무엇이 필요할까요?",
                                        "프라이팬이 뜨거워야 기름을 두를 수 있어요",
                                        "계란이 팬에 있어야 소금을 뿌릴 수 있어요"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "완벽한 요리 알고리즘이에요! 각 단계의 의존 관계를 잘 이해했어요.",
                                        "good": "순서가 잘 맞아요! 의존 관계 주석도 달아보세요.",
                                        "partial": "기본 순서는 맞지만, 일부 단계의 의존 관계를 다시 생각해보세요.",
                                        "wrong": "요리를 처음부터 상상해보세요. 불부터 켜야 다음 단계를 할 수 있어요."
                              }
                    },
                    {
                              "id": "c4",
                              "title": "순서 의존성 분석표",
                              "description": "5가지 아침 활동의 의존 관계를 분석해서 출력하세요. 어떤 것이 어떤 것에 의존하는지 화살표(->)로 표시하세요.",
                              "difficulty": "medium",
                              "starterCode": "# 아침 활동의 의존 관계를 분석하세요\n# 활동: 일어나기, 옷입기, 세수하기, 밥먹기, 등교하기\n\nprint(\"=== 의존 관계 분석 ===\")\nprint(\"일어나기 -> ???\")  # 일어나야 뭘 할 수 있을까?\n# 나머지 의존 관계를 적어보세요\n",
                              "solution": "print(\"=== 의존 관계 분석 ===\")\nprint(\"일어나기 -> 세수하기  (일어나야 세수 가능)\")\nprint(\"일어나기 -> 옷입기    (일어나야 옷입기 가능)\")\nprint(\"세수하기, 옷입기 -> 밥먹기  (준비 후 식사)\")\nprint(\"밥먹기 -> 등교하기    (밥 먹고 등교)\")\nprint()\nprint(\"독립 관계: 세수하기 <-> 옷입기 (순서 바꿔도 OK)\")",
                              "hints": [
                                        "모든 활동은 '일어나기'에 의존해요",
                                        "세수하기와 옷입기는 서로 독립적이에요",
                                        "등교하기는 모든 준비가 끝나야 해요"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "의존 관계 분석을 완벽하게 해냈어요! 독립 관계까지 찾다니 대단해요!",
                                        "good": "의존 관계를 잘 파악했어요! 독립 관계도 찾아보세요.",
                                        "partial": "일부 의존 관계를 놓쳤어요. 각 활동 전에 무엇을 해야 하는지 생각하세요.",
                                        "wrong": "각 활동을 하나씩 보고, 그 전에 반드시 해야 할 활동이 뭔지 적어보세요."
                              }
                    },
                    {
                              "id": "c5",
                              "title": "코드 순서 디버깅",
                              "description": "아래 Python 코드는 순서가 잘못되어 원하는 결과가 안 나와요. 순서를 고쳐서 올바른 출력이 나오게 하세요.",
                              "difficulty": "hard",
                              "starterCode": "# 이 코드는 순서가 잘못되었어요!\n# 원하는 출력: 자기소개가 순서대로 나와야 해요\n\nprint(\"감사합니다!\")\nprint(\"제 취미는 코딩이에요\")\nprint(\"=== 자기소개 ===\")\nprint(\"저는 12살이에요\")\nprint(\"안녕하세요, 저는 코딩왕이에요\")\n",
                              "solution": "print(\"=== 자기소개 ===\")\nprint(\"안녕하세요, 저는 코딩왕이에요\")\nprint(\"저는 12살이에요\")\nprint(\"제 취미는 코딩이에요\")\nprint(\"감사합니다!\")",
                              "hints": [
                                        "자기소개는 제목 -> 인사 -> 정보 -> 마무리 순이에요",
                                        "=== 제목 ===이 먼저 나와야 해요",
                                        "감사합니다는 마지막이에요"
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "코드 순서 디버깅에 성공했어요! 프로그래머의 중요한 능력이에요.",
                                        "good": "좋아요! 순서를 잘 맞췄어요. 코드에서도 순서가 중요하죠!",
                                        "partial": "자기소개 흐름을 생각하세요: 제목 -> 인사 -> 내용 -> 마무리",
                                        "wrong": "일반적인 자기소개 순서를 생각해보세요. 제목이 먼저, 감사인사가 마지막이에요."
                              }
                    }
          ],
          unlocked: false,
        ...
        },
        {
          ...
          drawPath: true,
                    challenges: [
                    {
                              "id": "c1",
                              "title": "로봇 기본 이동",
                              "description": "로봇이 (0,0)에서 출발해 (2,0) 위치까지 가야 해요. 오른쪽으로 2칸 이동하는 명령을 순서대로 작성하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 로봇을 오른쪽으로 2칸 이동시키세요\n# 사용 가능한 명령: 오른쪽으로, 왼쪽으로, 위로, 아래로\n\nprint(\"로봇 출발: (0,0)\")\nprint(\"명령 1: ???\")\nprint(\"명령 2: ???\")\nprint(\"도착: (2,0)\")\n",
                              "solution": "print(\"로봇 출발: (0,0)\")\nprint(\"명령 1: 오른쪽으로\")\nprint(\"명령 2: 오른쪽으로\")\nprint(\"도착: (2,0)\")",
                              "hints": [
                                        "오른쪽으로 가면 x좌표가 1씩 증가해요",
                                        "2칸 가려면 같은 명령을 2번 해야 해요",
                                        "로봇은 한 번에 1칸만 움직여요"
                              ],
                              "estimatedMinutes": 3,
                              "feedback": {
                                        "perfect": "로봇 이동 명령을 정확하게 작성했어요! 순차적 명령의 기초를 잘 이해했어요.",
                                        "good": "좋아요! 로봇이 목표 지점에 도착했어요.",
                                        "partial": "로봇은 한 번에 한 칸만 이동해요. 명령 수를 확인하세요.",
                                        "wrong": "오른쪽으로 2칸 가려면 '오른쪽으로' 명령을 2번 써야 해요."
                              }
                    },
                    {
                              "id": "c2",
                              "title": "경로 추적하기",
                              "description": "로봇에게 주어진 명령을 따라가면 어디에 도착할까요? 각 단계의 위치를 추적하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 로봇이 (0,0)에서 출발합니다\n# 명령: 오른쪽, 오른쪽, 아래, 아래, 오른쪽\n# 각 명령 후 위치를 출력하세요\n\nprint(\"시작: (0,0)\")\nprint(\"오른쪽 -> (1,0)\")\n# 나머지 경로를 추적하세요\n",
                              "solution": "print(\"시작: (0,0)\")\nprint(\"오른쪽 -> (1,0)\")\nprint(\"오른쪽 -> (2,0)\")\nprint(\"아래   -> (2,1)\")\nprint(\"아래   -> (2,2)\")\nprint(\"오른쪽 -> (3,2)\")\nprint(\"최종 도착: (3,2)\")",
                              "hints": [
                                        "오른쪽으로 가면 x좌표 +1, 아래로 가면 y좌표 +1",
                                        "각 명령 후의 좌표를 계산해서 적으세요",
                                        "이전 위치에서 변화된 좌표를 더하세요"
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "경로 추적을 완벽하게 했어요! 컴퓨터도 이렇게 명령을 한 단계씩 실행해요.",
                                        "good": "좋아요! 대부분의 경로를 잘 추적했어요.",
                                        "partial": "좌표 계산을 다시 확인하세요. 오른쪽 = x+1, 아래 = y+1이에요.",
                                        "wrong": "시작점(0,0)에서 한 명령씩 따라가며 좌표를 계산하세요."
                              }
                    },
                    {
                              "id": "c3",
                              "title": "장애물 피해가기",
                              "description": "3x3 격자에서 로봇이 (0,0)에서 (2,2)까지 가야 해요. (1,1)에 장애물이 있어요! 장애물을 피하는 경로를 만드세요.",
                              "difficulty": "medium",
                              "starterCode": "# 3x3 격자 (0,0) -> (2,2)\n# 장애물: (1,1)\n# 로봇은 장애물을 통과할 수 없어요!\n\nprint(\"=== 로봇 경로 ===\")\nprint(\"출발: (0,0)\")\n# 장애물 (1,1)을 피하는 경로를 작성하세요\nprint(\"도착: (2,2)\")\n",
                              "solution": "print(\"=== 로봇 경로 ===\")\nprint(\"출발: (0,0)\")\nprint(\"오른쪽 -> (1,0)\")\nprint(\"오른쪽 -> (2,0)\")\nprint(\"아래   -> (2,1)\")\nprint(\"아래   -> (2,2)\")\nprint(\"도착: (2,2) - 4칸 이동!\")",
                              "hints": [
                                        "(1,1)을 지나지 않는 경로를 찾으세요",
                                        "먼저 오른쪽으로 이동하고, 그 다음 아래로 가면 (1,1)을 피할 수 있어요",
                                        "여러 경로가 가능해요 - 가장 짧은 것을 찾아보세요"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "장애물을 피하는 최적 경로를 찾았어요! 알고리즘적 사고가 뛰어나요.",
                                        "good": "장애물을 잘 피했어요! 더 짧은 경로도 있을까요?",
                                        "partial": "경로가 장애물(1,1)을 지나가고 있어요. 다른 길을 찾아보세요.",
                                        "wrong": "장애물 위치(1,1)을 피해서 가는 경로를 그려보세요. 종이에 격자를 그리면 도움돼요."
                              }
                    },
                    {
                              "id": "c4",
                              "title": "명령 최적화",
                              "description": "로봇이 (0,0)에서 (1,2)까지 가는 가장 짧은 경로를 찾으세요. 최소 명령 수를 출력하세요.",
                              "difficulty": "medium",
                              "starterCode": "# 로봇: (0,0) -> (1,2)\n# 가장 적은 명령으로 도착하세요\n# 최소 명령 수도 출력하세요\n\nprint(\"=== 최적 경로 ===\")\nprint(\"출발: (0,0)\")\n# 경로를 작성하세요\nprint(\"총 명령 수: ???개\")\n",
                              "solution": "print(\"=== 최적 경로 ===\")\nprint(\"출발: (0,0)\")\nprint(\"오른쪽 -> (1,0)\")\nprint(\"아래   -> (1,1)\")\nprint(\"아래   -> (1,2)\")\nprint(\"도착: (1,2)\")\nprint(\"총 명령 수: 3개\")",
                              "hints": [
                                        "최소 이동 수 = 가로 거리 + 세로 거리",
                                        "오른쪽 1칸 + 아래 2칸 = 총 3칸이에요",
                                        "대각선 이동은 불가능해요"
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "최적 경로를 찾았어요! 최소 명령 수를 계산하는 것은 알고리즘 최적화의 기초예요.",
                                        "good": "목표에 도착했어요! 명령 수를 더 줄일 수 있는지 확인해보세요.",
                                        "partial": "도착은 했지만 더 짧은 경로가 있어요. 최단 거리를 계산해보세요.",
                                        "wrong": "가로 이동 횟수 + 세로 이동 횟수가 최소 명령 수예요."
                              }
                    },
                    {
                              "id": "c5",
                              "title": "역방향 경로 만들기",
                              "description": "로봇이 (3,3)에서 출발해 (0,0)으로 돌아가야 해요. 돌아가는 명령 시퀀스를 작성하세요.",
                              "difficulty": "hard",
                              "starterCode": "# 로봇이 집으로 돌아가요!\n# (3,3) -> (0,0)\n# 왼쪽으로, 위로 명령을 사용하세요\n\nprint(\"=== 귀환 경로 ===\")\nprint(\"현재 위치: (3,3)\")\n# 돌아가는 경로를 작성하세요\nprint(\"집 도착: (0,0)\")\n",
                              "solution": "print(\"=== 귀환 경로 ===\")\nprint(\"현재 위치: (3,3)\")\nprint(\"왼쪽으로 -> (2,3)\")\nprint(\"왼쪽으로 -> (1,3)\")\nprint(\"왼쪽으로 -> (0,3)\")\nprint(\"위로     -> (0,2)\")\nprint(\"위로     -> (0,1)\")\nprint(\"위로     -> (0,0)\")\nprint(\"집 도착: (0,0) - 총 6칸 이동!\")",
                              "hints": [
                                        "왼쪽으로 가면 x좌표 -1, 위로 가면 y좌표 -1이에요",
                                        "가는 경로의 반대 방향으로 돌아가면 돼요",
                                        "총 6번의 명령이 필요해요 (왼쪽 3번 + 위 3번)"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "역방향 경로를 완벽하게 만들었어요! 반대 방향 명령을 잘 활용했어요.",
                                        "good": "좋아요! 돌아가는 경로를 잘 만들었어요.",
                                        "partial": "좌표 계산을 다시 확인하세요. 왼쪽=x-1, 위=y-1이에요.",
                                        "wrong": "왼쪽과 위 방향으로 각각 3칸씩 이동해야 해요."
                              }
                    }
          ],
          unlocked: false,
          ...
          hints: [
            ...
            '어떤 규칙이 있는지 생각해보세요'
                    ...
                    challenges: [
                    {
                              "id": "c1",
                              "title": "색깔 패턴 완성하기",
                              "description": "반복되는 색깔 패턴을 분석하고, 다음에 올 색깔을 맞추세요. Python으로 패턴을 출력하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 패턴을 분석하고 다음 3개를 예측하세요\n# 패턴: 빨강 파랑 빨강 파랑 빨강 파랑 ???  ??? ???\n\nprint(\"패턴: 빨강 파랑 빨강 파랑 빨강 파랑\")\nprint(\"다음 3개: ???\")\n",
                              "solution": "print(\"패턴: 빨강 파랑 빨강 파랑 빨강 파랑\")\nprint(\"다음 3개: 빨강 파랑 빨강\")\nprint(\"규칙: 빨강과 파랑이 번갈아 반복!\")",
                              "hints": [
                                        "두 가지 색이 번갈아 나오는 패턴이에요",
                                        "빨-파, 빨-파... 다음은?",
                                        "마지막이 파랑이었으니 다음은?"
                              ],
                              "estimatedMinutes": 3,
                              "feedback": {
                                        "perfect": "패턴 인식 능력이 뛰어나요! AB반복 패턴을 정확히 파악했어요.",
                                        "good": "잘했어요! 반복 패턴을 잘 찾았어요.",
                                        "partial": "두 색이 번갈아 나오는 규칙을 다시 살펴보세요.",
                                        "wrong": "처음부터 하나씩 읽어보세요: 빨-파, 빨-파... 무엇이 반복되나요?"
                              }
                    },
                    {
                              "id": "c2",
                              "title": "숫자 패턴 찾기",
                              "description": "숫자 시퀀스의 규칙을 찾아 다음 수를 예측하세요. 3가지 패턴을 각각 분석하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 각 패턴의 규칙을 찾고, 다음 수를 예측하세요\n\nprint(\"패턴1: 2, 4, 6, 8, ???\")\nprint(\"규칙1: ???\")\nprint(\"다음수: ???\")\nprint()\nprint(\"패턴2: 1, 4, 7, 10, ???\")\nprint(\"규칙2: ???\")\nprint(\"다음수: ???\")\nprint()\nprint(\"패턴3: 1, 2, 4, 8, ???\")\nprint(\"규칙3: ???\")\nprint(\"다음수: ???\")\n",
                              "solution": "print(\"패턴1: 2, 4, 6, 8, 10\")\nprint(\"규칙1: 2씩 증가\")\nprint(\"다음수: 10\")\nprint()\nprint(\"패턴2: 1, 4, 7, 10, 13\")\nprint(\"규칙2: 3씩 증가\")\nprint(\"다음수: 13\")\nprint()\nprint(\"패턴3: 1, 2, 4, 8, 16\")\nprint(\"규칙3: 2배씩 증가\")\nprint(\"다음수: 16\")",
                              "hints": [
                                        "연속된 두 수의 차이를 구해보세요",
                                        "패턴1은 2씩 커져요, 패턴2는 3씩 커져요",
                                        "패턴3은 더하기가 아니라 곱하기예요!"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "세 가지 패턴을 모두 정확히 분석했어요! 등차와 등비 패턴을 구분할 수 있어요.",
                                        "good": "대부분의 패턴을 잘 찾았어요! 곱하기 패턴도 확인해보세요.",
                                        "partial": "연속된 수 사이의 관계를 더 자세히 살펴보세요.",
                                        "wrong": "각 수에서 이전 수를 빼보세요. 차이가 일정한지, 아니면 다른 규칙이 있는지 확인하세요."
                              }
                    },
                    {
                              "id": "c3",
                              "title": "코드 패턴 발견",
                              "description": "아래 코드에서 반복되는 패턴을 찾고, 패턴을 이용해 나머지를 완성하세요.",
                              "difficulty": "medium",
                              "starterCode": "# 패턴을 찾아서 빈칸을 채우세요!\n\nprint(\"*\")\nprint(\"**\")\nprint(\"***\")\n# 패턴을 이어서 2줄 더 작성하세요\n",
                              "solution": "print(\"*\")\nprint(\"**\")\nprint(\"***\")\nprint(\"****\")\nprint(\"*****\")",
                              "hints": [
                                        "별의 개수가 어떻게 변하는지 세어보세요",
                                        "1개, 2개, 3개... 다음은?",
                                        "한 줄씩 별이 1개씩 늘어나요"
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "증가 패턴을 정확히 찾았어요! 이런 패턴은 나중에 반복문으로 만들 수 있어요.",
                                        "good": "패턴을 잘 이어갔어요! 별 개수의 규칙을 말로 설명할 수 있나요?",
                                        "partial": "각 줄의 별 개수를 세어보세요. 1, 2, 3... 다음은?",
                                        "wrong": "첫째 줄은 별 1개, 둘째 줄은 2개, 셋째 줄은 3개... 이 규칙을 따르세요."
                              }
                    },
                    {
                              "id": "c4",
                              "title": "반복 패턴으로 그림 그리기",
                              "description": "패턴을 이용해서 다이아몬드 모양의 상단을 만드세요. 공백과 별의 패턴을 분석하세요.",
                              "difficulty": "medium",
                              "starterCode": "# 다이아몬드 상단을 만드세요\n# 공백과 별의 패턴을 찾아보세요!\n\nprint(\"    *\")      # 공백 4개 + 별 1개\nprint(\"   ***\")     # 공백 3개 + 별 3개\n# 패턴을 이어서 완성하세요\n",
                              "solution": "print(\"    *\")      # 공백 4개 + 별 1개\nprint(\"   ***\")     # 공백 3개 + 별 3개\nprint(\"  *****\")    # 공백 2개 + 별 5개\nprint(\" *******\")   # 공백 1개 + 별 7개\nprint(\"*********\")  # 공백 0개 + 별 9개",
                              "hints": [
                                        "공백은 4, 3, 2... 어떻게 변하나요?",
                                        "별은 1, 3, 5... 어떻게 변하나요?",
                                        "공백은 1씩 줄고, 별은 2씩 늘어나요"
                              ],
                              "estimatedMinutes": 6,
                              "feedback": {
                                        "perfect": "두 가지 패턴(공백 감소 + 별 증가)을 동시에 파악했어요! 패턴 분석의 달인!",
                                        "good": "다이아몬드 모양이 잘 나왔어요! 공백과 별의 규칙을 정리해보세요.",
                                        "partial": "공백 패턴과 별 패턴을 따로 분석해보세요.",
                                        "wrong": "공백: 4,3,2,1,0 / 별: 1,3,5,7,9 이 두 패턴을 조합하세요."
                              }
                    },
                    {
                              "id": "c5",
                              "title": "일상 속 패턴 프로그래밍",
                              "description": "일주일 요일 패턴과 월별 날수 패턴을 Python으로 표현하세요. 패턴이 어떻게 반복되는지 설명하세요.",
                              "difficulty": "hard",
                              "starterCode": "# 일상 속 패턴을 프로그래밍하세요!\n\n# 1. 요일 패턴 (7일 주기)\nprint(\"=== 요일 패턴 ===\")\nprint(\"월 화 수 목 금 토 일\")\nprint(\"주기: ???일\")\n\n# 2. 짝수 달의 날수 패턴을 찾아보세요\nprint(\"\\n=== 짝수 달 날수 ===\")\nprint(\"2월: 28일\")\nprint(\"4월: ???일\")\n# 나머지를 완성하세요\n",
                              "solution": "print(\"=== 요일 패턴 ===\")\nprint(\"월 화 수 목 금 토 일\")\nprint(\"주기: 7일마다 반복\")\nprint(\"14일 후 = 같은 요일!\")\n\nprint(\"\\n=== 짝수 달 날수 ===\")\nprint(\"2월: 28일\")\nprint(\"4월: 30일\")\nprint(\"6월: 30일\")\nprint(\"8월: 31일\")\nprint(\"10월: 31일\")\nprint(\"12월: 31일\")\nprint(\"패턴: 2월만 특별, 나머지는 30-31일 반복!\")",
                              "hints": [
                                        "요일은 7일마다 같은 패턴이 반복돼요",
                                        "짝수 달의 날수: 28, 30, 30, 31, 31, 31",
                                        "2월만 특별하고, 4-6월은 30일, 8-12월은 31일이에요"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "일상 속 패턴을 프로그래밍으로 완벽하게 표현했어요! 패턴은 어디에나 있어요!",
                                        "good": "잘했어요! 일상에서도 패턴을 찾을 수 있다는 걸 배웠어요.",
                                        "partial": "요일 패턴은 잘 했어요. 짝수 달의 날수도 정리해보세요.",
                                        "wrong": "달력을 떠올려보세요. 요일은 몇 일마다 반복되나요?"
                              }
                    }
          ],
          unlocked: false,
          ...
          hints: [
            ...
            '숫자가 어떻게 변하는지 보세요'
                    ...
                    challenges: [
                    {
                              "id": "c1",
                              "title": "이모지 패턴 예측",
                              "description": "이모지 시퀀스의 규칙을 찾아 다음에 올 이모지를 예측하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 각 패턴의 다음을 예측하세요\n\nprint(\"패턴1: 하트 별 하트 별 하트 별 ???\")\nprint(\"답1: ???\")\nprint()\nprint(\"패턴2: 해 해 달 해 해 달 해 해 ???\")\nprint(\"답2: ???\")\nprint()\nprint(\"패턴3: A BB CCC ???\")\nprint(\"답3: ???\")\n",
                              "solution": "print(\"패턴1: 하트 별 하트 별 하트 별 하트\")\nprint(\"답1: 하트 (2개씩 반복)\")\nprint()\nprint(\"패턴2: 해 해 달 해 해 달 해 해 달\")\nprint(\"답2: 달 (해해달 3개씩 반복)\")\nprint()\nprint(\"패턴3: A BB CCC DDDD\")\nprint(\"답3: DDDD (글자수가 1,2,3,4로 증가)\")",
                              "hints": [
                                        "패턴1: 두 개가 번갈아 나와요",
                                        "패턴2: 3개씩 묶어서 보세요",
                                        "패턴3: 글자 수와 글자 자체를 따로 보세요"
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "세 가지 다른 유형의 패턴을 모두 발견했어요! AB패턴, ABC패턴, 성장패턴 모두 이해했어요.",
                                        "good": "대부분 맞았어요! 각 패턴의 규칙을 말로 설명할 수 있나요?",
                                        "partial": "패턴의 반복 단위를 찾아보세요. 몇 개씩 묶이는지가 핵심이에요.",
                                        "wrong": "처음부터 천천히 읽으며 반복되는 부분을 찾아보세요."
                              }
                    },
                    {
                              "id": "c2",
                              "title": "수열의 규칙 찾기",
                              "description": "주어진 수열의 규칙을 발견하고, 규칙을 Python 주석으로 설명한 후 다음 3개의 수를 예측하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 수열의 규칙을 찾고 다음 3개 수를 예측하세요\n\n# 수열: 1, 1, 2, 3, 5, 8, ???, ???, ???\n# 규칙: ???\nprint(\"수열: 1, 1, 2, 3, 5, 8\")\nprint(\"규칙: ???\")\nprint(\"다음 3개: ???\")\n",
                              "solution": "print(\"수열: 1, 1, 2, 3, 5, 8\")\nprint(\"규칙: 앞의 두 수를 더하면 다음 수!\")\nprint(\"1+1=2, 1+2=3, 2+3=5, 3+5=8\")\nprint(\"다음 3개: 13, 21, 34\")\nprint(\"  5+8=13, 8+13=21, 13+21=34\")",
                              "hints": [
                                        "연속된 두 수 사이의 관계를 살펴보세요",
                                        "1+1=2, 1+2=3... 이전 두 수를 더해보세요",
                                        "이것은 피보나치 수열이라는 유명한 패턴이에요!"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "피보나치 수열을 발견했어요! 자연에서도 발견되는 유명한 패턴이에요.",
                                        "good": "규칙을 잘 찾았어요! 이 패턴은 해바라기 씨앗 배열에도 있어요.",
                                        "partial": "바로 앞 두 수를 더해보세요. 1+1=?, 1+2=?...",
                                        "wrong": "각 수가 바로 앞의 두 수의 합인지 확인해보세요: 1+1=2, 1+2=3..."
                              }
                    },
                    {
                              "id": "c3",
                              "title": "패턴으로 코드 완성",
                              "description": "출력 결과의 패턴을 발견하고, 빠진 줄을 완성하세요.",
                              "difficulty": "medium",
                              "starterCode": "# 패턴을 발견하고 빈칸을 채우세요!\n\nprint(\"1 x 1 = 1\")\nprint(\"2 x 2 = 4\")\nprint(\"3 x 3 = 9\")\n# 다음 3줄을 패턴에 맞게 작성하세요\n",
                              "solution": "print(\"1 x 1 = 1\")\nprint(\"2 x 2 = 4\")\nprint(\"3 x 3 = 9\")\nprint(\"4 x 4 = 16\")\nprint(\"5 x 5 = 25\")\nprint(\"6 x 6 = 36\")",
                              "hints": [
                                        "각 줄에서 숫자가 어떻게 바뀌나요?",
                                        "n x n = ? 형태예요. n이 1씩 증가해요",
                                        "이것은 제곱수 패턴이에요: 1, 4, 9, 16..."
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "제곱수 패턴을 완벽하게 발견했어요! 수학과 프로그래밍의 연결고리를 잘 이해했어요.",
                                        "good": "패턴을 잘 이어갔어요! n x n 패턴이죠.",
                                        "partial": "각 줄에서 어떤 숫자가 변하는지 주목하세요.",
                                        "wrong": "1x1, 2x2, 3x3... 다음은 4x4, 5x5... 이렇게 계속돼요."
                              }
                    },
                    {
                              "id": "c4",
                              "title": "복합 패턴 분석",
                              "description": "두 가지 패턴이 동시에 존재하는 시퀀스를 분석하세요. 숫자와 기호의 패턴을 각각 찾으세요.",
                              "difficulty": "medium",
                              "starterCode": "# 두 가지 패턴을 동시에 찾으세요!\n# 시퀀스: +1, -2, +3, -4, +5, ???, ???\n\nprint(\"시퀀스: +1, -2, +3, -4, +5\")\nprint(\"패턴1 (부호): ???\")\nprint(\"패턴2 (숫자): ???\")\nprint(\"다음 2개: ???\")\n",
                              "solution": "print(\"시퀀스: +1, -2, +3, -4, +5\")\nprint(\"패턴1 (부호): +와 -가 번갈아 나옴\")\nprint(\"패턴2 (숫자): 1, 2, 3, 4, 5... 1씩 증가\")\nprint(\"다음 2개: -6, +7\")",
                              "hints": [
                                        "부호(+/-)와 숫자를 따로 보세요",
                                        "부호: +, -, +, -, +... 번갈아 나와요",
                                        "숫자: 1, 2, 3, 4, 5... 1씩 커져요"
                              ...
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "복합 패턴을 분해해서 분석하는 능력이 뛰어나요! 분해(Decomposition)는 컴퓨팅 사고의 핵심이에요.",
                                        "good": "두 패턴을 잘 찾았어요! 복잡한 것을 나눠서 보는 연습을 더 해보세요.",
                                        "partial": "하나의 패턴은 찾았어요. 부호와 숫자를 따로 분석해보세요.",
                                        "wrong": "복잡해 보이지만, 부호와 숫자를 분리하면 각각 간단한 패턴이에요."
                              }
                    },
                    {
                              "id": "c5",
                              "title": "패턴 설계자 되기",
                              "description": "자신만의 패턴 3가지를 만들어 출력하세요. 각 패턴의 규칙도 설명하세요. (반복패턴, 증가패턴, 복합패턴 각 1개)",
                              "difficulty": "hard",
                              "starterCode": "# 자신만의 패턴 3가지를 만들어보세요!\n\nprint(\"=== 나만의 패턴 ===\")\nprint()\n# 1. 반복 패턴 (같은 것이 반복)\nprint(\"반복: ???\")\nprint(\"규칙: ???\")\nprint()\n# 2. 증가 패턴 (점점 커지는)\nprint(\"증가: ???\")\nprint(\"규칙: ???\")\nprint()\n# 3. 복합 패턴 (2가지 규칙 조합)\nprint(\"복합: ???\")\nprint(\"규칙: ???\")\n",
                              "solution": "print(\"=== 나만의 패턴 ===\")\nprint()\nprint(\"반복: 짝짝짝 쉬 짝짝짝 쉬 짝짝짝 쉬\")\nprint(\"규칙: 박수3번+쉬기가 반복\")\nprint()\nprint(\"증가: 1 10 100 1000 10000\")\nprint(\"규칙: 10배씩 커진다\")\nprint()\nprint(\"복합: A1 B2 C3 D4 E5\")\nprint(\"규칙: 알파벳+1, 숫자+1 동시 증가\")",
                              "hints": [
                                        "반복 패턴 예시: 짝짝 쉬 짝짝 쉬...",
                                        "증가 패턴 예시: 1, 10, 100, 1000...",
                                        "복합 패턴: 두 가지 규칙을 동시에 적용하세요"
                              ],
                              "estimatedMinutes": 6,
                              "feedback": {
                                        "perfect": "세 가지 유형의 패턴을 모두 창작했어요! 패턴을 발견하는 것뿐 아니라 만들 수도 있네요!",
                                        "good": "창의적인 패턴들이에요! 규칙 설명도 잘 했어요.",
                                        "partial": "패턴 유형이 겹치지 않게 반복/증가/복합 각각 만들어보세요.",
                                        "wrong": "반복=같은 것의 반복, 증가=점점 커지는 것, 복합=두 규칙의 조합이에요."
                              }
                    }
          ],
          unlocked: false,
          ...
          hints: [
            ...
            '상황에 따라 달라지는 것을 생각해보세요'
                    ...
                    challenges: [
                    {
                              "id": "c1",
                              "title": "일상 속 조건문 찾기",
                              "description": "'만약 ~라면 ~한다' 형태의 일상 조건문을 찾아 Python if문으로 표현하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 일상 속 조건문을 Python으로 표현하세요\n\n# 예시: 비가 오면 우산을 쓴다\nweather = \"비\"\nif weather == \"비\":\n    print(\"우산을 쓴다!\")\n\n# 1. 배고프면 밥을 먹는다\nhungry = True\n# if문을 작성하세요\n\n# 2. 시험 점수가 90점 이상이면 칭찬받는다\nscore = 95\n# if문을 작성하세요\n",
                              "solution": "weather = \"비\"\nif weather == \"비\":\n    print(\"우산을 쓴다!\")\n\nhungry = True\nif hungry:\n    print(\"밥을 먹는다!\")\n\nscore = 95\nif score >= 90:\n    print(\"칭찬받는다!\")",
                              "hints": [
                                        "if 다음에 조건을 쓰고 콜론(:)을 붙이세요",
                                        "True/False는 그냥 if hungry: 로 쓸 수 있어요",
                                        "90점 이상은 >= 90으로 표현해요"
                              ],
                              "estimatedMinutes": 4,
                              "feedback": {
                                        "perfect": "일상 조건문을 Python if문으로 완벽하게 변환했어요! 조건문의 기본을 정확히 이해했어요.",
                                        "good": "잘했어요! if문의 기본 구조를 잘 사용했어요.",
                                        "partial": "if 조건: 형태를 기억하세요. 들여쓰기도 중요해요!",
                                        "wrong": "if 뒤에 조건을 쓰고, 콜론(:) 다음 줄에 들여쓰기해서 실행할 내용을 쓰세요."
                              }
                    },
                    {
                              "id": "c2",
                              "title": "참과 거짓 판별",
                              "description": "주어진 조건이 참(True)인지 거짓(False)인지 판별하고, 결과를 출력하세요.",
                              "difficulty": "easy",
                              "starterCode": "# 각 조건이 참인지 거짓인지 출력하세요\n\nprint(\"10 > 5 는\", 10 > 5)\nprint(\"3 == 4 는\", 3 == 4)\n\n# 아래 조건의 결과를 예측하고 코드를 작성하세요\n# 7 >= 7\n# 10 != 10\n# 100 < 50\n",
                              "solution": "print(\"10 > 5 는\", 10 > 5)\nprint(\"3 == 4 는\", 3 == 4)\nprint(\"7 >= 7 는\", 7 >= 7)\nprint(\"10 != 10 는\", 10 != 10)\nprint(\"100 < 50 는\", 100 < 50)",
                              "hints": [
                                        ">= 는 '크거나 같다'예요. 7은 7과 같으므로 True!",
                                        "!= 는 '같지 않다'예요. 10은 10과 같으므로 False!",
                                        "비교 결과는 항상 True 또는 False예요"
                              ],
                              "estimatedMinutes": 3,
                              "feedback": {
                                        "perfect": "비교 연산자를 완벽히 이해했어요! True/False 판별이 조건문의 핵심이에요.",
                                        "good": "비교 연산을 잘 했어요! >=와 !=도 익숙해졌나요?",
                                        "partial": ">=는 '크거나 같다', !=는 '같지 않다'를 기억하세요.",
                                        "wrong": "각 비교 기호의 의미: > 크다, >= 크거나같다, == 같다, != 같지않다, < 작다"
                              }
                    },
                    {
                              "id": "c3",
                              "title": "if-else 날씨 프로그램",
                              "description": "날씨에 따라 다른 행동을 추천하는 프로그램을 만드세요. if-else를 사용하세요.",
                              "difficulty": "medium",
                              "starterCode": "# 날씨에 따른 행동 추천 프로그램\n\nweather = \"맑음\"\n\n# if-else로 날씨별 행동을 추천하세요\n# 맑음 -> 소풍 가기\n# 비 -> 실내 활동\n# 눈 -> 눈사람 만들기\n# 그 외 -> 자유 시간\n",
                              "solution": "weather = \"맑음\"\n\nif weather == \"맑음\":\n    print(\"날씨가 맑아요! 소풍 가기 좋은 날!\")\nelif weather == \"비\":\n    print(\"비가 와요! 실내에서 책 읽기!\")\nelif weather == \"눈\":\n    print(\"눈이 와요! 눈사람 만들기!\")\nelse:\n    print(\"자유 시간! 하고 싶은 거 하기!\")",
                              "hints": [
                                        "여러 조건을 검사할 때는 elif를 사용해요",
                                        "어떤 조건에도 해당하지 않으면 else를 사용해요",
                                        "if -> elif -> elif -> else 순서로 작성하세요"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "if-elif-else를 완벽하게 사용했어요! 여러 조건을 처리하는 프로그램을 만들 수 있어요.",
                                        "good": "좋아요! 조건 분기를 잘 구현했어요.",
                                        "partial": "elif로 여러 조건을 연결하고, else로 나머지를 처리하세요.",
                                        "wrong": "if weather == 값: 형태로 시작하고, elif와 else로 다른 경우를 처리하세요."
                              }
                    },
                    {
                              "id": "c4",
                              "title": "성적표 프로그램",
                              "description": "점수에 따라 등급을 매기는 성적표 프로그램을 완성하세요. (90+ A, 80+ B, 70+ C, 그 외 F)",
                              "difficulty": "medium",
                              "starterCode": "# 성적표 프로그램\n# 90점 이상: A\n# 80점 이상: B\n# 70점 이상: C\n# 70점 미만: F\n\nscore = 85\n\nprint(\"점수:\", score)\n# if-elif-else로 등급을 출력하세요\n",
                              "solution": "score = 85\n\nprint(\"점수:\", score)\nif score >= 90:\n    print(\"등급: A - 훌륭해요!\")\nelif score >= 80:\n    print(\"등급: B - 잘했어요!\")\nelif score >= 70:\n    print(\"등급: C - 괜찮아요!\")\nelse:\n    print(\"등급: F - 더 노력하세요!\")",
                              "hints": [
                                        "가장 높은 점수 조건(90점)부터 확인하세요",
                                        "elif로 다음 조건(80점, 70점)을 이어서 검사해요",
                                        "어떤 조건에도 해당하지 않으면 else로 F를 출력해요"
                              ],
                              "estimatedMinutes": 5,
                              "feedback": {
                                        "perfect": "성적표 프로그램을 완벽하게 만들었어요! 조건의 순서가 중요하다는 것을 이해했어요.",
                                        "good": "잘 동작해요! 조건 순서를 높은 것부터 낮은 것으로 잘 배치했어요.",
                                        "partial": "조건 순서가 중요해요. 90 -> 80 -> 70 순서로 검사하세요.",
                                        "wrong": "if score >= 90: 부터 시작해서 elif로 80, 70을 검사하고 else로 나머지를 처리하세요."
                              }
                    },
                    {
                              "id": "c5",
                              "title": "조건문 미니 게임",
                              "description": "플레이어의 상태에 따라 다른 결과가 나오는 미니 RPG를 만드세요. HP, 무기, 레벨 조건을 모두 사용하세요.",
                              "difficulty": "hard",
                              "starterCode": "# RPG 미니 게임\n# HP, 무기, 레벨에 따라 결과가 달라져요!\n\nhp = 80\nweapon = \"검\"\nlevel = 5\n\nprint(\"=== 전투 시작! ===\")\nprint(\"HP:\", hp, \"| 무기:\", weapon, \"| 레벨:\", level)\nprint()\n\n# 조건:\n# HP가 0 이하면 -> 게임 오버\n# 레벨이 10 이상이고 무기가 \"전설의검\" -> 보스 처치!\n# 레벨이 5 이상 -> 몬스터 처치!\n# 그 외 -> 도망가세요!\n",
                              "solution": "hp = 80\nweapon = \"검\"\nlevel = 5\n\nprint(\"=== 전투 시작! ===\")\nprint(\"HP:\", hp, \"| 무기:\", weapon, \"| 레벨:\", level)\nprint()\n\nif hp <= 0:\n    print(\"게임 오버... HP가 0이에요!\")\nelif level >= 10 and weapon == \"전설의검\":\n    print(\"보스를 처치했어요! 전설의 용사!\")\nelif level >= 5:\n    print(\"몬스터를 처치했어요! 경험치 +100\")\nelse:\n    print(\"도망가세요! 아직 레벨이 부족해요!\")",
                              "hints": [
                                        "두 가지 조건을 동시에 검사할 때는 and를 사용해요",
                                        "가장 중요한 조건(HP 0)을 먼저 검사하세요",
                                        "조건의 순서: 게임오버 -> 보스처치 -> 몬스터처치 -> 도망"
                              ],
                              "estimatedMinutes": 6,
                              "feedback": {
                                        "perfect": "복합 조건문을 활용한 미니 게임을 완벽하게 만들었어요! and 연산자와 조건 우선순위를 잘 이해했어요.",
                                        "good": "게임이 잘 동작해요! and 조건도 잘 사용했어요.",
                                        "partial": "and로 두 조건을 결합하는 부분을 다시 확인하세요.",
                                        "wrong": "if hp <= 0: 부터 시작하세요. and는 두 조건 사이에 써서 둘 다 참일 때 실행돼요."
                              }
                    }
          ],
          unlocked: false,
