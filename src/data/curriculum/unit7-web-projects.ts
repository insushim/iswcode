    ...
    // ============================================================
    {
      ...
      missions: [
        ...
        },
        {
          ...
          hints: ['💡 단계별로 접근하세요'],
          challenges: [
            { id: 'c1', title: 'async 함수 선언', description: 'async function을 선언하세요.', difficulty: 'easy', starterCode: 'async function hello() {}', solution: 'async function hello() {\n  return "안녕";\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: 'async/await async 함수 선언을(를) 완벽하게 구현했어요!', good: 'async 함수 선언 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: 'async 함수 선언에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c2', title: 'await 사용', description: 'await로 Promise를 기다리세요.', difficulty: 'easy', starterCode: 'async function wait() {}', solution: 'async function wait() {\n  const result = await fetch(url);\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: 'async/await await 사용을(를) 완벽하게 구현했어요!', good: 'await 사용 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: 'await 사용에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c3', title: 'try/catch 추가', description: '에러를 처리하세요.', difficulty: 'easy', starterCode: 'async function safe() {}', solution: 'async function safe() {\n  try { await fetch(url); } catch(e) { console.error(e); }\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: 'async/await try/catch 추가을(를) 완벽하게 구현했어요!', good: 'try/catch 추가 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: 'try/catch 추가에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c4', title: '여러 await 순차', description: '두 API를 순서대로 호출하세요.', difficulty: 'medium', starterCode: 'async function seq() {}', solution: 'async function seq() {\n  const a = await fetch(url1);\n  const b = await fetch(url2);\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: 'async/await 여러 await 순차을(를) 완벽하게 구현했어요!', good: '여러 await 순차 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: '여러 await 순차에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c5', title: 'Promise.all 병렬', description: '두 API를 동시에 호출하세요.', difficulty: 'medium', starterCode: 'async function par() {}', solution: 'async function par() {\n  const [a,b] = await Promise.all([fetch(url1),fetch(url2)]);\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: 'async/await Promise.all 병렬을(를) 완벽하게 구현했어요!', good: 'Promise.all 병렬 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: 'Promise.all 병렬에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c6', title: '응답 처리', description: 'JSON으로 변환하세요.', difficulty: 'medium', starterCode: '// 변환', solution: 'const data = await response.json();', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: 'async/await 응답 처리을(를) 완벽하게 구현했어요!', good: '응답 처리 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: '응답 처리에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c7', title: '에러 타입 구분', description: '네트워크/HTTP 에러를 구분하세요.', difficulty: 'hard', starterCode: 'async function check() {}', solution: 'async function check() {\n  try {\n    const r = await fetch(url);\n    if(!r.ok) throw new Error("HTTP "+r.status);\n  } catch(e) { console.error(e); }\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: 'async/await 에러 타입 구분을(를) 완벽하게 구현했어요!', good: '에러 타입 구분 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: '에러 타입 구분에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c8', title: '로딩 상태', description: '로딩 표시를 추가하세요.', difficulty: 'hard', starterCode: 'async function load() {}', solution: 'async function load() {\n  showLoading();\n  try { await fetch(url); } finally { hideLoading(); }\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: 'async/await 로딩 상태을(를) 완벽하게 구현했어요!', good: '로딩 상태 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: '로딩 상태에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c9', title: '재시도 로직', description: '실패 시 3번 재시도하세요.', difficulty: 'hard', starterCode: 'async function retry(url,n) {}', solution: 'async function retry(url,n=3) {\n  for(let i=0;i<n;i++) {\n    try { return await fetch(url).then(r=>r.json()); } catch(e) { if(i===n-1) throw e; }\n  }\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: 'async/await 재시도 로직을(를) 완벽하게 구현했어요!', good: '재시도 로직 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: '재시도 로직에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } },
            { id: 'c10', title: '타임아웃 구현', description: '5초 타임아웃을 추가하세요.', difficulty: 'hard', starterCode: 'async function fetchTimeout() {}', solution: 'async function fetchTimeout(url,ms=5000) {\n  const ctrl = new AbortController();\n  setTimeout(()=>ctrl.abort(),ms);\n  return fetch(url,{signal:ctrl.signal});\n}', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: 'async/await 타임아웃 구현을(를) 완벽하게 구현했어요!', good: '타임아웃 구현 구현을 잘했어요! async/await 패턴을 이해하고 있어요.', partial: '타임아웃 구현에서 async/await 사용법을 다시 확인해보세요.', wrong: 'async 함수 안에서 await를 사용하고, try/catch로 에러를 처리하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
          ...
          hints: ['💡 단계별로 접근하세요'],
          challenges: [
            { id: 'c1', title: '검색 입력창', description: 'input과 button을 만드세요.', difficulty: 'easy', starterCode: '<div id="search"></div>', solution: '<div id="search"><input type="text" id="city" placeholder="도시"><button id="btn">검색</button></div>', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: '날씨 앱 UI의 검색 입력창을(를) 완벽하게 만들었어요!', good: '검색 입력창을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '검색 입력창에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c2', title: '날씨 카드', description: '온도/설명/습도를 보여주는 카드를 만드세요.', difficulty: 'easy', starterCode: '<div class="card"></div>', solution: '<div class="card"><h2 id="temp">22도</h2><p id="desc">맑음</p><p id="hum">습도 65%</p></div>', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: '날씨 앱 UI의 날씨 카드을(를) 완벽하게 만들었어요!', good: '날씨 카드을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '날씨 카드에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c3', title: '아이콘 영역', description: '날씨 아이콘 img를 추가하세요.', difficulty: 'easy', starterCode: '<!-- 아이콘 -->', solution: '<img id="icon" src="" alt="날씨 아이콘" style="display:none">', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: '날씨 앱 UI의 아이콘 영역을(를) 완벽하게 만들었어요!', good: '아이콘 영역을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '아이콘 영역에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c4', title: '카드 CSS', description: '카드에 그림자와 둥근 모서리를 적용하세요.', difficulty: 'medium', starterCode: '.card {}', solution: '.card {padding:20px;border-radius:16px;box-shadow:0 4px 15px rgba(0,0,0,0.1);}', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: '날씨 앱 UI의 카드 CSS을(를) 완벽하게 만들었어요!', good: '카드 CSS을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '카드 CSS에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c5', title: '그라데이션 배경', description: '날씨에 따른 그라데이션을 적용하세요.', difficulty: 'medium', starterCode: 'body {}', solution: 'body {background:linear-gradient(135deg,#667eea,#764ba2);min-height:100vh;}', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: '날씨 앱 UI의 그라데이션 배경을(를) 완벽하게 만들었어요!', good: '그라데이션 배경을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '그라데이션 배경에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c6', title: '반응형 레이아웃', description: '모바일에서도 잘 보이게 하세요.', difficulty: 'medium', starterCode: '@media (max-width:480px) {}', solution: '@media (max-width:480px) {.card{margin:10px;padding:15px;} input{width:100%;}}', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: '날씨 앱 UI의 반응형 레이아웃을(를) 완벽하게 만들었어요!', good: '반응형 레이아웃을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '반응형 레이아웃에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c7', title: '예보 리스트', description: '5일 예보를 리스트로 표시하세요.', difficulty: 'hard', starterCode: '<div id="forecast"></div>', solution: '<div id="forecast"><div class="day"><span>월</span><span>22도</span></div></div>', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: '날씨 앱 UI의 예보 리스트을(를) 완벽하게 만들었어요!', good: '예보 리스트을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '예보 리스트에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c8', title: '로딩 스피너', description: 'CSS 로딩 애니메이션을 만드세요.', difficulty: 'hard', starterCode: '.spinner {}', solution: '.spinner {width:40px;height:40px;border:4px solid #eee;border-top:4px solid #667eea;border-radius:50%;animation:spin 1s linear infinite;} @keyframes spin{to{transform:rotate(360deg)}}', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: '날씨 앱 UI의 로딩 스피너을(를) 완벽하게 만들었어요!', good: '로딩 스피너을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '로딩 스피너에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c9', title: '에러 메시지 UI', description: '에러 메시지를 빨간색 박스로 표시하세요.', difficulty: 'hard', starterCode: '.error {}', solution: '.error {background:#fee;color:#c33;padding:12px;border-radius:8px;border:1px solid #fcc;}', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: '날씨 앱 UI의 에러 메시지 UI을(를) 완벽하게 만들었어요!', good: '에러 메시지 UI을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '에러 메시지 UI에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } },
            { id: 'c10', title: '전체 UI 통합', description: '모든 UI 요소를 하나로 합치세요.', difficulty: 'hard', starterCode: '<!-- 전체 UI -->', solution: '<div id="app"><h1>날씨 앱</h1><div id="search"><input id="city" placeholder="도시"><button id="btn">검색</button></div><div id="loading" class="spinner" style="display:none"></div><div class="card" id="weather" style="display:none"><img id="icon"><h2 id="temp"></h2><p id="desc"></p></div><div id="error" class="error" style="display:none"></div></div>', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: '날씨 앱 UI의 전체 UI 통합을(를) 완벽하게 만들었어요!', good: '전체 UI 통합을(를) 잘 만들었어요! UI 디자인 감각이 좋아요.', partial: '전체 UI 통합에서 빠진 요소가 있어요. 날씨 UI 가이드를 참고하세요.', wrong: '날씨 앱에 필요한 HTML/CSS 요소를 하나씩 추가해보세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
          ...
          hints: ['💡 단계별로 접근하세요'],
          challenges: [
            { id: 'c1', title: 'API 호출 기초 1', description: 'API 호출의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// API 호출 연습\n', solution: '// API 호출 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 기초 1 완벽!', good: 'API 호출 기초 1을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 기초 1에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c2', title: 'API 호출 실습 2', description: 'API 호출을 직접 구현하세요.', difficulty: 'easy', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 실습 2 완벽!', good: 'API 호출 실습 2을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 실습 2에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c3', title: 'API 호출 기초 3', description: 'API 호출의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// API 호출 연습\n', solution: '// API 호출 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 기초 3 완벽!', good: 'API 호출 기초 3을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 기초 3에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c4', title: 'API 호출 실습 4', description: 'API 호출을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 실습 4 완벽!', good: 'API 호출 실습 4을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 실습 4에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c5', title: 'API 호출 기초 5', description: 'API 호출의 기본을 연습하세요.', difficulty: 'medium', starterCode: '// API 호출 연습\n', solution: '// API 호출 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 기초 5 완벽!', good: 'API 호출 기초 5을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 기초 5에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c6', title: 'API 호출 실습 6', description: 'API 호출을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 실습 6 완벽!', good: 'API 호출 실습 6을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 실습 6에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c7', title: 'API 호출 기초 7', description: 'API 호출의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// API 호출 연습\n', solution: '// API 호출 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 기초 7 완벽!', good: 'API 호출 기초 7을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 기초 7에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c8', title: 'API 호출 실습 8', description: 'API 호출을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 실습 8 완벽!', good: 'API 호출 실습 8을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 실습 8에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c9', title: 'API 호출 기초 9', description: 'API 호출의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// API 호출 연습\n', solution: '// API 호출 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 기초 9 완벽!', good: 'API 호출 기초 9을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 기초 9에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } },
            { id: 'c10', title: 'API 호출 실습 10', description: 'API 호출을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: 'API 호출 실력이 프로 수준이에요! API 호출 실습 10 완벽!', good: 'API 호출 실습 10을(를) 잘 구현했어요! fetch 패턴을 이해하고 있어요.', partial: 'API 호출 실습 10에서 API 호출 방식을 다시 확인해보세요. fetch → then → catch 순서예요.', wrong: 'fetch(url).then(res => res.json()).then(data => ...) 패턴을 사용하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
          ...
          hints: ['💡 단계별로 접근하세요'],
          challenges: [
            { id: 'c1', title: 'DOM 업데이트 기초 1', description: 'DOM 업데이트의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// DOM 업데이트 연습\n', solution: '// DOM 업데이트 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 기초 1 훌륭해요!', good: 'DOM 업데이트 기초 1을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 기초 1에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c2', title: 'DOM 업데이트 실습 2', description: 'DOM 업데이트을 직접 구현하세요.', difficulty: 'easy', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 실습 2 훌륭해요!', good: 'DOM 업데이트 실습 2을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 실습 2에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c3', title: 'DOM 업데이트 기초 3', description: 'DOM 업데이트의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// DOM 업데이트 연습\n', solution: '// DOM 업데이트 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 기초 3 훌륭해요!', good: 'DOM 업데이트 기초 3을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 기초 3에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c4', title: 'DOM 업데이트 실습 4', description: 'DOM 업데이트을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 실습 4 훌륭해요!', good: 'DOM 업데이트 실습 4을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 실습 4에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c5', title: 'DOM 업데이트 기초 5', description: 'DOM 업데이트의 기본을 연습하세요.', difficulty: 'medium', starterCode: '// DOM 업데이트 연습\n', solution: '// DOM 업데이트 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 기초 5 훌륭해요!', good: 'DOM 업데이트 기초 5을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 기초 5에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c6', title: 'DOM 업데이트 실습 6', description: 'DOM 업데이트을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 실습 6 훌륭해요!', good: 'DOM 업데이트 실습 6을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 실습 6에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c7', title: 'DOM 업데이트 기초 7', description: 'DOM 업데이트의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// DOM 업데이트 연습\n', solution: '// DOM 업데이트 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 기초 7 훌륭해요!', good: 'DOM 업데이트 기초 7을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 기초 7에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c8', title: 'DOM 업데이트 실습 8', description: 'DOM 업데이트을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 실습 8 훌륭해요!', good: 'DOM 업데이트 실습 8을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 실습 8에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c9', title: 'DOM 업데이트 기초 9', description: 'DOM 업데이트의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// DOM 업데이트 연습\n', solution: '// DOM 업데이트 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 기초 9 훌륭해요!', good: 'DOM 업데이트 기초 9을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 기초 9에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } },
            { id: 'c10', title: 'DOM 업데이트 실습 10', description: 'DOM 업데이트을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: 'DOM 조작을 완벽하게 이해했어요! DOM 업데이트 실습 10 훌륭해요!', good: 'DOM 업데이트 실습 10을(를) 잘 구현했어요! DOM 업데이트를 잘 다루고 있어요.', partial: 'DOM 업데이트 실습 10에서 DOM 요소 선택이나 값 설정을 다시 확인해보세요.', wrong: 'document.getElementById()로 요소를 선택하고 textContent나 innerHTML을 설정하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
          ...
          hints: ['💡 단계별로 접근하세요'],
          challenges: [
            { id: 'c1', title: '이벤트+API 기초 1', description: '이벤트+API의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// 이벤트+API 연습\n', solution: '// 이벤트+API 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 기초 1 멋져요!', good: '이벤트+API 기초 1을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 기초 1에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c2', title: '이벤트+API 실습 2', description: '이벤트+API을 직접 구현하세요.', difficulty: 'easy', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 실습 2 멋져요!', good: '이벤트+API 실습 2을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 실습 2에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c3', title: '이벤트+API 기초 3', description: '이벤트+API의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// 이벤트+API 연습\n', solution: '// 이벤트+API 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 기초 3 멋져요!', good: '이벤트+API 기초 3을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 기초 3에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c4', title: '이벤트+API 실습 4', description: '이벤트+API을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 실습 4 멋져요!', good: '이벤트+API 실습 4을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 실습 4에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c5', title: '이벤트+API 기초 5', description: '이벤트+API의 기본을 연습하세요.', difficulty: 'medium', starterCode: '// 이벤트+API 연습\n', solution: '// 이벤트+API 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 기초 5 멋져요!', good: '이벤트+API 기초 5을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 기초 5에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c6', title: '이벤트+API 실습 6', description: '이벤트+API을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 실습 6 멋져요!', good: '이벤트+API 실습 6을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 실습 6에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c7', title: '이벤트+API 기초 7', description: '이벤트+API의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// 이벤트+API 연습\n', solution: '// 이벤트+API 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 기초 7 멋져요!', good: '이벤트+API 기초 7을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 기초 7에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c8', title: '이벤트+API 실습 8', description: '이벤트+API을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 실습 8 멋져요!', good: '이벤트+API 실습 8을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 실습 8에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c9', title: '이벤트+API 기초 9', description: '이벤트+API의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// 이벤트+API 연습\n', solution: '// 이벤트+API 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 기초 9 멋져요!', good: '이벤트+API 기초 9을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 기초 9에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } },
            { id: 'c10', title: '이벤트+API 실습 10', description: '이벤트+API을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: '이벤트와 API를 완벽하게 연결했어요! 이벤트+API 실습 10 멋져요!', good: '이벤트+API 실습 10을(를) 잘 구현했어요! 이벤트-API 연동을 잘 이해하고 있어요.', partial: '이벤트+API 실습 10에서 이벤트 리스너와 API 호출 연결을 다시 확인해보세요.', wrong: 'addEventListener로 이벤트를 감지하고, 콜백에서 fetch를 호출하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
          ...
          hints: ['💡 단계별로 접근하세요'],
          challenges: [
            { id: 'c1', title: '에러 처리 기초 1', description: '에러 처리의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// 에러 처리 연습\n', solution: '// 에러 처리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 기초 1 프로 수준!', good: '에러 처리 기초 1을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 기초 1에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c2', title: '에러 처리 실습 2', description: '에러 처리을 직접 구현하세요.', difficulty: 'easy', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 실습 2 프로 수준!', good: '에러 처리 실습 2을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 실습 2에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c3', title: '에러 처리 기초 3', description: '에러 처리의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// 에러 처리 연습\n', solution: '// 에러 처리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 기초 3 프로 수준!', good: '에러 처리 기초 3을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 기초 3에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c4', title: '에러 처리 실습 4', description: '에러 처리을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 실습 4 프로 수준!', good: '에러 처리 실습 4을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 실습 4에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c5', title: '에러 처리 기초 5', description: '에러 처리의 기본을 연습하세요.', difficulty: 'medium', starterCode: '// 에러 처리 연습\n', solution: '// 에러 처리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 기초 5 프로 수준!', good: '에러 처리 기초 5을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 기초 5에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c6', title: '에러 처리 실습 6', description: '에러 처리을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 실습 6 프로 수준!', good: '에러 처리 실습 6을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 실습 6에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c7', title: '에러 처리 기초 7', description: '에러 처리의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// 에러 처리 연습\n', solution: '// 에러 처리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 기초 7 프로 수준!', good: '에러 처리 기초 7을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 기초 7에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c8', title: '에러 처리 실습 8', description: '에러 처리을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 실습 8 프로 수준!', good: '에러 처리 실습 8을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 실습 8에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c9', title: '에러 처리 기초 9', description: '에러 처리의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// 에러 처리 연습\n', solution: '// 에러 처리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 기초 9 프로 수준!', good: '에러 처리 기초 9을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 기초 9에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } },
            { id: 'c10', title: '에러 처리 실습 10', description: '에러 처리을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: '에러 처리를 완벽하게 구현했어요! 에러 처리 실습 10 프로 수준!', good: '에러 처리 실습 10을(를) 잘 구현했어요! 안정적인 에러 처리예요.', partial: '에러 처리 실습 10에서 try/catch 구조나 에러 메시지 처리를 보완하세요.', wrong: 'try { ... } catch(error) { console.error(error); } 패턴을 사용하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
          ...
          challenges: [
            { id: 'c1', title: 'CSS 마무리 기초 1', description: 'CSS 마무리의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// CSS 마무리 연습\n', solution: '// CSS 마무리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 기초 1 프로 디자이너 수준!', good: 'CSS 마무리 기초 1을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 기초 1에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c2', title: 'CSS 마무리 실습 2', description: 'CSS 마무리을 직접 구현하세요.', difficulty: 'easy', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 실습 2 프로 디자이너 수준!', good: 'CSS 마무리 실습 2을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 실습 2에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c3', title: 'CSS 마무리 기초 3', description: 'CSS 마무리의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// CSS 마무리 연습\n', solution: '// CSS 마무리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 기초 3 프로 디자이너 수준!', good: 'CSS 마무리 기초 3을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 기초 3에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c4', title: 'CSS 마무리 실습 4', description: 'CSS 마무리을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 실습 4 프로 디자이너 수준!', good: 'CSS 마무리 실습 4을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 실습 4에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c5', title: 'CSS 마무리 기초 5', description: 'CSS 마무리의 기본을 연습하세요.', difficulty: 'medium', starterCode: '// CSS 마무리 연습\n', solution: '// CSS 마무리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 기초 5 프로 디자이너 수준!', good: 'CSS 마무리 기초 5을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 기초 5에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c6', title: 'CSS 마무리 실습 6', description: 'CSS 마무리을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 실습 6 프로 디자이너 수준!', good: 'CSS 마무리 실습 6을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 실습 6에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c7', title: 'CSS 마무리 기초 7', description: 'CSS 마무리의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// CSS 마무리 연습\n', solution: '// CSS 마무리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 기초 7 프로 디자이너 수준!', good: 'CSS 마무리 기초 7을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 기초 7에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c8', title: 'CSS 마무리 실습 8', description: 'CSS 마무리을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 실습 8 프로 디자이너 수준!', good: 'CSS 마무리 실습 8을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 실습 8에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c9', title: 'CSS 마무리 기초 9', description: 'CSS 마무리의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// CSS 마무리 연습\n', solution: '// CSS 마무리 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 기초 9 프로 디자이너 수준!', good: 'CSS 마무리 기초 9을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 기초 9에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } },
            { id: 'c10', title: 'CSS 마무리 실습 10', description: 'CSS 마무리을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: 'CSS 스타일링이 완벽해요! CSS 마무리 실습 10 프로 디자이너 수준!', good: 'CSS 마무리 실습 10을(를) 잘 적용했어요! CSS 감각이 좋아요.', partial: 'CSS 마무리 실습 10에서 CSS 속성값을 다시 확인해보세요.', wrong: 'CSS 속성과 값을 정확하게 작성하고, 브라우저에서 확인하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
          ...
          hints: ['💡 단계별로 접근하세요'],
          challenges: [
            { id: 'c1', title: 'API 복습 기초 1', description: 'API 복습의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// API 복습 연습\n', solution: '// API 복습 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 5, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 기초 1 만점!', good: 'API 복습 기초 1을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 기초 1에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c2', title: 'API 복습 실습 2', description: 'API 복습을 직접 구현하세요.', difficulty: 'easy', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 7, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 실습 2 만점!', good: 'API 복습 실습 2을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 실습 2에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c3', title: 'API 복습 기초 3', description: 'API 복습의 기본을 연습하세요.', difficulty: 'easy', starterCode: '// API 복습 연습\n', solution: '// API 복습 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 9, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 기초 3 만점!', good: 'API 복습 기초 3을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 기초 3에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c4', title: 'API 복습 실습 4', description: 'API 복습을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 11, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 실습 4 만점!', good: 'API 복습 실습 4을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 실습 4에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c5', title: 'API 복습 기초 5', description: 'API 복습의 기본을 연습하세요.', difficulty: 'medium', starterCode: '// API 복습 연습\n', solution: '// API 복습 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 13, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 기초 5 만점!', good: 'API 복습 기초 5을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 기초 5에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c6', title: 'API 복습 실습 6', description: 'API 복습을 직접 구현하세요.', difficulty: 'medium', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 15, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 실습 6 만점!', good: 'API 복습 실습 6을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 실습 6에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c7', title: 'API 복습 기초 7', description: 'API 복습의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// API 복습 연습\n', solution: '// API 복습 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 17, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 기초 7 만점!', good: 'API 복습 기초 7을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 기초 7에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c8', title: 'API 복습 실습 8', description: 'API 복습을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 19, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 실습 8 만점!', good: 'API 복습 실습 8을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 실습 8에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c9', title: 'API 복습 기초 9', description: 'API 복습의 기본을 연습하세요.', difficulty: 'hard', starterCode: '// API 복습 연습\n', solution: '// API 복습 완성!\nconsole.log("완료");', hints: ['단계별로 접근하세요'], estimatedMinutes: 21, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 기초 9 만점!', good: 'API 복습 기초 9을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 기초 9에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } },
            { id: 'c10', title: 'API 복습 실습 10', description: 'API 복습을 직접 구현하세요.', difficulty: 'hard', starterCode: '// 구현하세요\n', solution: '// 구현 완료!', hints: ['단계별로 접근하세요'], estimatedMinutes: 23, feedback: { perfect: 'API 개념을 완벽하게 이해했어요! API 복습 실습 10 만점!', good: 'API 복습 실습 10을(를) 잘 풀었어요! API 지식이 탄탄해요.', partial: 'API 복습 실습 10에서 API 관련 개념을 다시 복습해보세요.', wrong: 'fetch, async/await, 에러 처리의 기본 개념을 복습하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
      ],
    ...
    // ============================================================
    {
      ...
      missions: [
        ...
        },
        {
          ...
          hints: ['💡 실제 포트폴리오 사이트를 참고하세요'],
          challenges: [
            { id: 'c1', title: '히어로 배경', description: '전체 화면 배경 이미지를 설정하세요.', difficulty: 'easy', starterCode: '.hero {}', solution: '.hero {height:100vh;background:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(bg.jpg) center/cover;}', hints: ['단계별로 진행하세요'], estimatedMinutes: 5, feedback: { perfect: '히어로 섹션의 히어로 배경을(를) 완벽하게 구현했어요!', good: '히어로 배경을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '히어로 배경에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c2', title: '가운데 텍스트', description: '히어로 텍스트를 정중앙에 배치하세요.', difficulty: 'easy', starterCode: '.hero-content {}', solution: '.hero-content {position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);text-align:center;color:white;}', hints: ['단계별로 진행하세요'], estimatedMinutes: 7, feedback: { perfect: '히어로 섹션의 가운데 텍스트을(를) 완벽하게 구현했어요!', good: '가운데 텍스트을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '가운데 텍스트에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c3', title: 'CTA 버튼', description: '눈에 띄는 CTA 버튼을 만드세요.', difficulty: 'easy', starterCode: '.cta {}', solution: '.cta {padding:15px 40px;font-size:18px;background:#667eea;color:white;border:none;border-radius:30px;cursor:pointer;transition:transform 0.3s;} .cta:hover{transform:scale(1.05);}', hints: ['단계별로 진행하세요'], estimatedMinutes: 9, feedback: { perfect: '히어로 섹션의 CTA 버튼을(를) 완벽하게 구현했어요!', good: 'CTA 버튼을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: 'CTA 버튼에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c4', title: '타이핑 효과', description: 'CSS로 타이핑 애니메이션을 만드세요.', difficulty: 'medium', starterCode: '.typing {}', solution: '.typing {border-right:3px solid;white-space:nowrap;overflow:hidden;animation:typing 3s steps(20) forwards, blink 0.8s infinite;} @keyframes typing{from{width:0}to{width:100%}} @keyframes blink{50%{border-color:transparent}}', hints: ['단계별로 진행하세요'], estimatedMinutes: 11, feedback: { perfect: '히어로 섹션의 타이핑 효과을(를) 완벽하게 구현했어요!', good: '타이핑 효과을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '타이핑 효과에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c5', title: '스크롤 화살표', description: '아래로 스크롤을 유도하는 화살표를 만드세요.', difficulty: 'medium', starterCode: '.scroll-arrow {}', solution: '.scroll-arrow {position:absolute;bottom:30px;left:50%;transform:translateX(-50%);animation:bounce 2s infinite;} @keyframes bounce{0%,100%{transform:translateX(-50%) translateY(0)}50%{transform:translateX(-50%) translateY(10px)}}', hints: ['단계별로 진행하세요'], estimatedMinutes: 13, feedback: { perfect: '히어로 섹션의 스크롤 화살표을(를) 완벽하게 구현했어요!', good: '스크롤 화살표을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '스크롤 화살표에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c6', title: '파티클 배경', description: '움직이는 배경 효과를 CSS로 만드세요.', difficulty: 'medium', starterCode: '.particles {}', solution: '.particles {background:radial-gradient(circle,rgba(255,255,255,0.1) 1px,transparent 1px);background-size:30px 30px;animation:float 20s linear infinite;} @keyframes float{to{background-position:100px 200px}}', hints: ['단계별로 진행하세요'], estimatedMinutes: 15, feedback: { perfect: '히어로 섹션의 파티클 배경을(를) 완벽하게 구현했어요!', good: '파티클 배경을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '파티클 배경에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c7', title: '네비게이션 통합', description: '히어로 위에 투명 네비게이션을 올리세요.', difficulty: 'hard', starterCode: 'nav {}', solution: 'nav {position:fixed;top:0;width:100%;display:flex;justify-content:space-between;padding:20px 40px;background:transparent;z-index:10;transition:background 0.3s;} nav.scrolled{background:rgba(0,0,0,0.9);}', hints: ['단계별로 진행하세요'], estimatedMinutes: 17, feedback: { perfect: '히어로 섹션의 네비게이션 통합을(를) 완벽하게 구현했어요!', good: '네비게이션 통합을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '네비게이션 통합에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c8', title: '반응형 히어로', description: '모바일 대응 히어로를 만드세요.', difficulty: 'hard', starterCode: '@media {}', solution: '@media (max-width:768px){.hero-content h1{font-size:28px;} .cta{padding:12px 30px;font-size:16px;}}', hints: ['단계별로 진행하세요'], estimatedMinutes: 19, feedback: { perfect: '히어로 섹션의 반응형 히어로을(를) 완벽하게 구현했어요!', good: '반응형 히어로을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '반응형 히어로에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c9', title: '소셜 링크', description: 'GitHub/LinkedIn 링크를 아이콘으로 추가하세요.', difficulty: 'hard', starterCode: '<div class="social"></div>', solution: '<div class="social"><a href="#" aria-label="GitHub">GH</a><a href="#" aria-label="LinkedIn">LI</a></div>', hints: ['단계별로 진행하세요'], estimatedMinutes: 21, feedback: { perfect: '히어로 섹션의 소셜 링크을(를) 완벽하게 구현했어요!', good: '소셜 링크을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '소셜 링크에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } },
            { id: 'c10', title: '전체 히어로 통합', description: '완전한 히어로 섹션을 만드세요.', difficulty: 'hard', starterCode: '<!-- 히어로 -->', solution: '<section class="hero"><nav><a class="logo">Portfolio</a><div class="nav-links"><a href="#about">소개</a><a href="#projects">프로젝트</a><a href="#contact">연락처</a></div></nav><div class="hero-content"><h1>안녕하세요, 개발자입니다</h1><p>웹을 만드는 것을 좋아해요</p><a href="#projects" class="cta">프로젝트 보기</a></div><div class="scroll-arrow">v</div></section>', hints: ['단계별로 진행하세요'], estimatedMinutes: 23, feedback: { perfect: '히어로 섹션의 전체 히어로 통합을(를) 완벽하게 구현했어요!', good: '전체 히어로 통합을(를) 잘 만들었어요! 포트폴리오가 멋져지고 있어요.', partial: '전체 히어로 통합에서 CSS 속성이나 위치값을 다시 확인해보세요.', wrong: '히어로 섹션의 레이아웃 속성(position, flexbox)을 확인하세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
        ...
        },
        {
          ...
          hints: ['💡 실제 포트폴리오 사이트를 참고하세요'],
          challenges: [
            { id: 'c1', title: 'Grid 기본', description: 'display: grid를 적용하세요.', difficulty: 'easy', starterCode: '.gallery {}', solution: '.gallery {display:grid;grid-template-columns:repeat(3,1fr);gap:20px;}', hints: ['단계별로 진행하세요'], estimatedMinutes: 5, feedback: { perfect: 'CSS Grid로 Grid 기본을(를) 완벽하게 구현했어요!', good: 'Grid 기본을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: 'Grid 기본에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c2', title: '카드 만들기', description: '프로젝트 카드를 만드세요.', difficulty: 'easy', starterCode: '<div class="project-card"></div>', solution: '<div class="project-card"><img src="project.png" alt="프로젝트"><h3>퀴즈 앱</h3><p>HTML/CSS/JS</p><a href="#" class="btn">보기</a></div>', hints: ['단계별로 진행하세요'], estimatedMinutes: 7, feedback: { perfect: 'CSS Grid로 카드 만들기을(를) 완벽하게 구현했어요!', good: '카드 만들기을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '카드 만들기에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c3', title: '카드 호버', description: '호버 시 확대+그림자 효과를 만드세요.', difficulty: 'easy', starterCode: '.project-card {}', solution: '.project-card {border-radius:12px;overflow:hidden;transition:transform 0.3s,box-shadow 0.3s;} .project-card:hover{transform:translateY(-5px);box-shadow:0 10px 30px rgba(0,0,0,0.15);}', hints: ['단계별로 진행하세요'], estimatedMinutes: 9, feedback: { perfect: 'CSS Grid로 카드 호버을(를) 완벽하게 구현했어요!', good: '카드 호버을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '카드 호버에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c4', title: '이미지 오버레이', description: '호버 시 이미지 위에 오버레이를 표시하세요.', difficulty: 'medium', starterCode: '.overlay {}', solution: '.project-card{position:relative;} .overlay{position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);opacity:0;transition:opacity 0.3s;display:flex;align-items:center;justify-content:center;} .project-card:hover .overlay{opacity:1;}', hints: ['단계별로 진행하세요'], estimatedMinutes: 11, feedback: { perfect: 'CSS Grid로 이미지 오버레이을(를) 완벽하게 구현했어요!', good: '이미지 오버레이을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '이미지 오버레이에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c5', title: '기술 태그', description: '프로젝트에 사용한 기술 태그를 표시하세요.', difficulty: 'medium', starterCode: '.tags {}', solution: '.tags {display:flex;gap:8px;flex-wrap:wrap;} .tag{padding:4px 12px;background:#e8e8ff;color:#667eea;border-radius:20px;font-size:12px;}', hints: ['단계별로 진행하세요'], estimatedMinutes: 13, feedback: { perfect: 'CSS Grid로 기술 태그을(를) 완벽하게 구현했어요!', good: '기술 태그을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '기술 태그에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c6', title: '반응형 그리드', description: '화면 크기에 따라 열 수를 조정하세요.', difficulty: 'medium', starterCode: '@media {}', solution: '@media (max-width:768px){.gallery{grid-template-columns:repeat(2,1fr);}} @media (max-width:480px){.gallery{grid-template-columns:1fr;}}', hints: ['단계별로 진행하세요'], estimatedMinutes: 15, feedback: { perfect: 'CSS Grid로 반응형 그리드을(를) 완벽하게 구현했어요!', good: '반응형 그리드을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '반응형 그리드에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c7', title: '필터 버튼', description: '카테고리별 필터 버튼을 만드세요.', difficulty: 'hard', starterCode: '.filters {}', solution: '.filters {display:flex;gap:10px;margin-bottom:20px;} .filter-btn{padding:8px 16px;border:2px solid #667eea;border-radius:20px;background:transparent;cursor:pointer;} .filter-btn.active{background:#667eea;color:white;}', hints: ['단계별로 진행하세요'], estimatedMinutes: 17, feedback: { perfect: 'CSS Grid로 필터 버튼을(를) 완벽하게 구현했어요!', good: '필터 버튼을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '필터 버튼에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c8', title: 'JS 필터 기능', description: '버튼 클릭 시 프로젝트를 필터링하세요.', difficulty: 'hard', starterCode: 'function filter(cat) {}', solution: 'function filter(cat) {\n  document.querySelectorAll(".project-card").forEach(card => {\n    card.style.display = (cat === "all" || card.dataset.category === cat) ? "block" : "none";\n  });\n}', hints: ['단계별로 진행하세요'], estimatedMinutes: 19, feedback: { perfect: 'CSS Grid로 JS 필터 기능을(를) 완벽하게 구현했어요!', good: 'JS 필터 기능을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: 'JS 필터 기능에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c9', title: '프로젝트 모달', description: '프로젝트 클릭 시 상세 모달을 표시하세요.', difficulty: 'hard', starterCode: 'function openModal() {}', solution: 'function openModal(card) {\n  document.getElementById("modal").style.display = "flex";\n  document.getElementById("modal-title").textContent = card.querySelector("h3").textContent;\n}', hints: ['단계별로 진행하세요'], estimatedMinutes: 21, feedback: { perfect: 'CSS Grid로 프로젝트 모달을(를) 완벽하게 구현했어요!', good: '프로젝트 모달을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '프로젝트 모달에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } },
            { id: 'c10', title: '갤러리 완성', description: '필터+그리드+모달을 통합하세요.', difficulty: 'hard', starterCode: '<!-- 갤러리 -->', solution: '<section id="projects"><h2>프로젝트</h2><div class="filters"><button class="filter-btn active" onclick="filter(\'all\')">전체</button><button class="filter-btn" onclick="filter(\'web\')">웹</button></div><div class="gallery"><div class="project-card" data-category="web"><img src="p1.png"><h3>퀴즈 앱</h3></div></div></section>', hints: ['단계별로 진행하세요'], estimatedMinutes: 23, feedback: { perfect: 'CSS Grid로 갤러리 완성을(를) 완벽하게 구현했어요!', good: '갤러리 완성을(를) 잘 만들었어요! Grid 레이아웃을 잘 활용하고 있어요.', partial: '갤러리 완성에서 Grid 속성값을 다시 확인해보세요.', wrong: 'display: grid와 grid-template-columns를 사용해보세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        },
        {
        ...
        },
        {
          ...
          hints: ['💡 실제 포트폴리오 사이트를 참고하세요'],
          challenges: [
            { id: 'c1', title: 'Git 초기화', description: 'git init으로 저장소를 초기화하세요.', difficulty: 'easy', starterCode: '# 터미널 명령어를 적으세요', solution: 'git init\ngit add .\ngit commit -m "first commit"', hints: ['단계별로 진행하세요'], estimatedMinutes: 5, feedback: { perfect: 'Git 초기화 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: 'Git 초기화을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: 'Git 초기화에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c2', title: 'GitHub 저장소 생성', description: 'GitHub에서 새 저장소를 만드는 단계를 적으세요.', difficulty: 'easy', starterCode: '# GitHub 저장소 생성 단계', solution: '# 1. github.com에서 New Repository 클릭\n# 2. 저장소 이름 입력 (username.github.io)\n# 3. Public 선택\n# 4. Create Repository', hints: ['단계별로 진행하세요'], estimatedMinutes: 7, feedback: { perfect: 'GitHub 저장소 생성 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: 'GitHub 저장소 생성을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: 'GitHub 저장소 생성에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c3', title: '원격 저장소 연결', description: 'git remote add로 연결하세요.', difficulty: 'easy', starterCode: '# 원격 저장소 연결', solution: 'git remote add origin https://github.com/user/repo.git\ngit push -u origin main', hints: ['단계별로 진행하세요'], estimatedMinutes: 9, feedback: { perfect: '원격 저장소 연결 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: '원격 저장소 연결을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: '원격 저장소 연결에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c4', title: 'GitHub Pages 설정', description: 'Settings에서 Pages를 활성화하는 단계를 적으세요.', difficulty: 'medium', starterCode: '# GitHub Pages 설정 단계', solution: '# 1. Settings 탭 클릭\n# 2. Pages 메뉴 선택\n# 3. Source: main branch 선택\n# 4. Save 클릭\n# 5. URL 확인: https://user.github.io/repo', hints: ['단계별로 진행하세요'], estimatedMinutes: 11, feedback: { perfect: 'GitHub Pages 설정 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: 'GitHub Pages 설정을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: 'GitHub Pages 설정에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c5', title: 'index.html 필수', description: '메인 파일이 index.html이어야 하는 이유를 설명하세요.', difficulty: 'medium', starterCode: '// 왜 index.html?', solution: '// GitHub Pages는 index.html을 기본 페이지로 사용\n// 다른 이름이면 404 에러 발생\n// 모든 파일이 루트에 있어야 함', hints: ['단계별로 진행하세요'], estimatedMinutes: 13, feedback: { perfect: 'index.html 필수 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: 'index.html 필수을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: 'index.html 필수에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c6', title: '파일 구조 정리', description: '포트폴리오 파일 구조를 정리하세요.', difficulty: 'medium', starterCode: '// 파일 구조', solution: '// /\n// ├── index.html\n// ├── style.css\n// ├── script.js\n// └── images/\n//     ├── profile.jpg\n//     └── projects/', hints: ['단계별로 진행하세요'], estimatedMinutes: 15, feedback: { perfect: '파일 구조 정리 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: '파일 구조 정리을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: '파일 구조 정리에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c7', title: '메타 태그 SEO', description: '검색엔진 최적화 메타 태그를 추가하세요.', difficulty: 'hard', starterCode: '<head>\n  <!-- 메타 태그 -->\n</head>', solution: '<head>\n  <meta charset="UTF-8">\n  <meta name="viewport" content="width=device-width, initial-scale=1.0">\n  <meta name="description" content="프론트엔드 개발자 포트폴리오">\n  <meta property="og:title" content="나의 포트폴리오">\n  <meta property="og:image" content="preview.png">\n  <title>나의 포트폴리오</title>\n</head>', hints: ['단계별로 진행하세요'], estimatedMinutes: 17, feedback: { perfect: '메타 태그 SEO 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: '메타 태그 SEO을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: '메타 태그 SEO에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c8', title: '파비콘 추가', description: '브라우저 탭에 표시될 아이콘을 추가하세요.', difficulty: 'hard', starterCode: '<!-- 파비콘 -->', solution: '<link rel="icon" type="image/png" href="favicon.png">\n<link rel="apple-touch-icon" href="apple-touch-icon.png">', hints: ['단계별로 진행하세요'], estimatedMinutes: 19, feedback: { perfect: '파비콘 추가 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: '파비콘 추가을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: '파비콘 추가에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c9', title: '배포 확인', description: '배포된 사이트를 테스트하는 체크리스트를 만드세요.', difficulty: 'hard', starterCode: '// 배포 체크리스트', solution: '// 1. URL 접속 확인\n// 2. 모든 이미지 로드 확인\n// 3. 링크 동작 확인\n// 4. 모바일 테스트\n// 5. 콘솔 에러 확인\n// 6. 로딩 속도 확인', hints: ['단계별로 진행하세요'], estimatedMinutes: 21, feedback: { perfect: '배포 확인 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: '배포 확인을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: '배포 확인에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } },
            { id: 'c10', title: 'README 작성', description: 'GitHub 저장소의 README.md를 작성하세요.', difficulty: 'hard', starterCode: '# README 내용', solution: '# 나의 포트폴리오\n\n프론트엔드 개발자 포트폴리오 웹사이트입니다.\n\n## 기술 스택\n- HTML5\n- CSS3 (Flexbox, Grid)\n- JavaScript\n\n## 배포\nhttps://user.github.io\n\n## 기능\n- 반응형 디자인\n- 다크 모드\n- 프로젝트 갤러리', hints: ['단계별로 진행하세요'], estimatedMinutes: 23, feedback: { perfect: 'README 작성 단계를 완벽하게 이해했어요! 배포 준비 완료!', good: 'README 작성을(를) 잘 정리했어요! 배포 과정을 잘 이해하고 있어요.', partial: 'README 작성에서 빠진 단계가 있어요. 배포 가이드를 다시 확인하세요.', wrong: 'Git 명령어와 GitHub Pages 설정 단계를 하나씩 따라해보세요.' } }
          ],
          unlocked: true, completed: false, perfectScore: false
        }
      ],
